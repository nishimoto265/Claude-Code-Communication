...
echo "     tmux send-keys -t multiagent:0.0 'claude --model claude-opus-4-20250514 --dangerously-skip-permissions' C-m  # Boss Agent"
echo "     tmux send-keys -t multiagent:0.1 'claude --model claude-sonnet-4-20250514 --dangerously-skip-permissions' C-m # Worker Agent"
echo ""
echo "  3. 📜 指示書確認:"
