...
echo "     tmux send-keys -t multiagent:0.0 'claude --model claude-3-opus-20240229 --dangerously-skip-permissions' C-m  # Boss Agent"
echo "     tmux send-keys -t multiagent:0.1 'claude --model claude-3-sonnet-20240229 --dangerously-skip-permissions' C-m # Worker Agent"
echo ""
echo "  3. 📜 指示書確認:"
